package com.example.ilhamrazk.myfirebasedispatcher;
...
public class MyJobService extends JobService {
    ...
    final String APP_ID = "4bc47c5e4d33cd17b14715249ec31aaa";
    ...
    public boolean onStartJob(JobParameters job) {
        ...
        //return true ketika ingin dijalankan proses dengan thread yang berbeda, msial asynctask
        return true;
    }

    /**
     * onStopJob akan dipanggil ketika proses belum selesai dikarenakan contraint requirements tidak terpenuhi
        ...
        client.get(url, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, byte[] responseBody) {
                ...
                try {
                    ...
                    // ketika terjadi error, maka jobFinisihed diset denganparameter true. Yang artinya job perlu di reschedule
            ...
            public void onFailure(int statusCode, Header[] headers, byte[] responseBody, Throwable error) {
                //ketika proses gagal, maka jobFinisher diset dengan parameter true. Yang artinya job perlu di reschedule
                jobFinished(job,true);
            }
        });
    }
     ...
     *
     * @param context context dari notfication
